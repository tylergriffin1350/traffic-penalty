...
import { Search, FileCheck, AlertCircle, Phone, BadgeInfo } from "lucide-react";
...
export function DriverSearch({ onSearch, isLoading }: DriverSearchProps) {
    ...
    <Card className="mb-8 shadow-lg border-0">
      <CardHeader className="bg-gradient-to-r from-pink-50 to-pink-100 rounded-t-lg pb-6">
        <CardTitle className="text-2xl text-pink-800 flex items-center">
          ...
          Penalty Approval Management
        </CardTitle>
        <CardDescription className="text-pink-600">
          Search for a driver by license number or phone number to manage
          penalties.
        </CardDescription>
      </CardHeader>
